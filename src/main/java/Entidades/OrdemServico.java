...
public class OrdemServico {
    ...
    private int ativo = 1; // Campo para indicar se a ordem está ativa (1) ou não (0)
     ...
     */
    public OrdemServico(int idOrdem, LocalDateTime dataAbertura, LocalDateTime dataConclusao, Status status,
            Cliente cliente, Funcionario funcionario, LocalDateTime createdAt, LocalDateTime updatedAt) {
     ...
     */
    public OrdemServico(int idOrdem, LocalDateTime dataAbertura, LocalDateTime dataConclusao, Status status,
            Cliente cliente, Funcionario funcionario, String descricao, LocalDateTime createdAt,
    ...
    /**
     * Construtor que inicializa uma ordem de serviço com os atributos fornecidos,
     * incluindo a descrição e o valor pago.
     *
     * @param idOrdem       Identificador único da ordem de serviço.
     * @param dataAbertura  Data de abertura da ordem.
     * @param dataConclusao Data de conclusão da ordem.
     ...
     */
    public OrdemServico(int idOrdem, LocalDateTime dataAbertura, LocalDateTime dataConclusao, Cliente cliente,
            Funcionario funcionario, String descricao, double valorPago) {
        this.idOrdem = idOrdem;
        this.dataAbertura = dataAbertura;
        this.dataConclusao = dataConclusao;
        this.cliente = cliente;
    ...
    /**
     * Construtor que inicializa uma ordem de serviço com os atributos fornecidos,
     * incluindo a descrição, o valor pago e as datas de criação e atualização.
     *
     * @param idOrdem       Identificador único da ordem de serviço.
     * @param dataAbertura  Data de abertura da ordem.
     * @param dataConclusao Data de conclusão da ordem.
     ...
     */
    public OrdemServico(int idOrdem, LocalDateTime dataAbertura, LocalDateTime dataConclusao, Status status,
            Cliente cliente, Funcionario funcionario, String descricao, double valorPago, LocalDateTime createdAt,
            LocalDateTime updatedAt) {
        this.idOrdem = idOrdem;
        this.dataAbertura = dataAbertura;
        this.dataConclusao = dataConclusao;
    ...
    /**
     * //ativo
     * Obtém o status de ativo da ordem de serviço.
     * 
     * @return 1 se ativo, 0 se não ativo.
     */
    public int getAtivo() {
        return ativo;
    }
    ...
    /**
     * Define o status de ativo da ordem de serviço.
     *
    ...
    /**
     * Sobrescrita do método {@code toString} para retornar os dados da ordem de
     * serviço.
     * A string retornada contém o ID, datas, status, cliente, funcionário, serviço
     * associados e valor pago.
     *
