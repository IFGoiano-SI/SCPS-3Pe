...
/**
 * Classe que representa um funcionário, estendendo os atributos básicos de
 * PessoaAbstract.
 */
public class Funcionario extends PessoaAbstract {
     ...
     */
    public Funcionario(int idFuncionario, String nome, String telefone, String email, Endereco endereco, String cargo,
     ...
     * A string retornada contém o nome, ID, cargo, telefone, e-mail e usuário
     * associado.
     *
